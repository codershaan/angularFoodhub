...
describe('HomeComponent', ()=>{
    ...
    it('trigger get special menu Items', () => {
        let response: Array<MenuItem> = [];
        spyOn(appService, 'getSpecialMenuItems').and.returnValue(of(response))
        component.getSpecialMenuItems();
        expect(component.specialMenuItems).toEqual(response);
    });

    it('Trigger navigateAboutUs method redirects you to /about', fakeAsync(() => {
