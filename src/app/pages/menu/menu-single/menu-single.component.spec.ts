...
describe('MenuSingleComponent', ()=>{
    ...
    it('trigger get get menu Item by ID', () => {
        ...
        const spySubscribable = spyOn(component, 'getMenuItemById').and.callThrough();
        component.getMenuItemById(11);
        expect(spySubscribable).toHaveBeenCalled();
        //expect(component.menuItem).toEqual(response);
    });
});